...
echo "   Watch the release workflow: https://github.com/pdomain/pdomain-ocr-ops/actions"
echo "   Release page (once workflow finishes): https://github.com/pdomain/pdomain-ocr-ops/releases/tag/$VERSION"
