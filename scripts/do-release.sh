...
echo "   Watch the release workflow: https://github.com/ConcaveTrillion/pd-ocr-ops/actions"
echo "   Release page (once workflow finishes): https://github.com/ConcaveTrillion/pd-ocr-ops/releases/tag/$VERSION"
